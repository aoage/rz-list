    ...
    public static class DataSeeder
    {
        ...
        private static List<Book> GetTestBooks()
        {
            return new List<Book>
            {
                ...
                new Book { Title = "Divergent", Author = "Veronica Roth", Publisher = "Katherine Tegen Books", Genre = Genre.YoungAdult, Description = "A dystopian novel set in post-apocalyptic Chicago with faction system.", PublishedDate = new DateTime(2011, 4, 25), CoverImageUrl = "https://covers.openlibrary.org/b/isbn/9780062024022-L.jpg", CharacterCount = 487000 },
